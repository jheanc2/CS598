...
filename="/home/pi/Downloads/Lab3/part1/17:18:59.csv"
...
height=1.63 # in meters # Change the height of the user as needed
...
for i in range(len(z_calib)):
    if i in peak_array:
        theta = yaw[i]
        txx.append(np.sin(theta))
        tyy.append(np.cos(theta))
    else:
        txx.append(0)
        tyy.append(0)
